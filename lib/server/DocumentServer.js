...
var DocumentServer = /** @class */ (function () {
    ...
    DocumentServer.prototype.receiveOperation = function (operationRevision, operation) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.transformReceivedOperation(operationRevision, operation)];
                    case 1:
                        transformedOperation = _a.sent();
                        this.operationRecieved.emit(transformedOperation);
                        return [2 /*return*/, transformedOperation];
                }
            });
        });
    };
    DocumentServer.prototype.transformReceivedOperation = function (operationRevision, operation) {
        return __awaiter(this, void 0, void 0, function () {
            var concurrentOperations, i;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getOperationsAfterRevision(operationRevision)];
                    case 1:
                        concurrentOperations = _a.sent();
                        // ... and transform the operation against all these operations.
                        for (i = 0; i < concurrentOperations.length; i++) {
                            operation = WrappedOperation_1.WrappedOperation.transform(operation, new WrappedOperation_1.WrappedOperation(concurrentOperations[i], null))[0];
                        }
